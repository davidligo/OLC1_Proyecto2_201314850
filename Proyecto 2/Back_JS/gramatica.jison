...
clase_interfaz
    : RPUBLIC RCLASS IDENTIFICADOR bloqueclase_interfaz  { let arreglo4 = []; arreglo4.push($1); arreglo4.push($2); arreglo4.push($3); arreglo4.push($4); $$ = new ast("clase_interfaz",arreglo4);  }
    | RPUBLIC RINTERFACE IDENTIFICADOR bloqueinterfaz { let arreglo42 = []; arreglo42.push($1); arreglo42.push($2); arreglo42.push($3); arreglo42.push($4); $$ = new ast("clase_interfaz",arreglo42);  }
...
bloqueinterfaz
    : LLAVIZQ  LLAVDER { let arreglobloqueinterfaz1 = []; arreglobloqueinterfaz1.push($1); arreglobloqueinterfaz1.push($2); $$ = new ast("bloqueinterfaz",arreglobloqueinterfaz1); }
    | LLAVIZQ lista_instrucciones_interfaz LLAVDER { let arreglobloqueinterfaz2 = []; arreglobloqueinterfaz2.push($1); arreglobloqueinterfaz2.push($2); arreglobloqueinterfaz2.push($3); $$ = new ast("bloqueinterfaz",arreglobloqueinterfaz2); }
;

lista_instrucciones_interfaz
    : lista_instrucciones_interfaz instrucciones_interfaz { let arreglolista_instrucciones_interfaz = []; arreglolista_instrucciones_interfaz.push($1); arreglolista_instrucciones_interfaz.push($2); $$ = new ast("lista_instrucciones_interfaz", arreglolista_instrucciones_interfaz); }
    | instrucciones_interfaz { $$ = new ast("lista_instrucciones_interfaz",new Array($1));  }
;

instrucciones_interfaz
    : RPUBLIC tipo_funcion IDENTIFICADOR bloqueparametros  PTCOMA { let arregloinstrucciones_interfaz= []; arregloinstrucciones_interfaz.push($1); arregloinstrucciones_interfaz.push($2); arregloinstrucciones_interfaz.push($3); arregloinstrucciones_interfaz.push($4); arregloinstrucciones_interfaz.push($5); $$ = new ast("instrucciones_interfaz", arregloinstrucciones_interfaz); }
; 
