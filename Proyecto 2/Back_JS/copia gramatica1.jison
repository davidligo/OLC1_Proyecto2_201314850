...
expresion_logica
	: expresion_relacional AND expresion_relacional     { let arregloexpresion_logica1 = []; arregloexpresion_logica1.push($1); arregloexpresion_logica1.push($2); arregloexpresion_logica1.push($3); $$ = new ast("expresion_logica", arregloexpresion_logica1);}
	| expresion_relacional OR expresion_relacional 		{ let arregloexpresion_logica2 = []; arregloexpresion_logica2.push($1); arregloexpresion_logica2.push($2); arregloexpresion_logica2.push($3); $$ = new ast("expresion_logica", arregloexpresion_logica2);}
    | expresion_relacional XOR expresion_relacional 	{ let arregloexpresion_logica3 = []; arregloexpresion_logica3.push($1); arregloexpresion_logica3.push($2); arregloexpresion_logica3.push($3); $$ = new ast("expresion_logica", arregloexpresion_logica3);}
	| NOT expresion_relacional							{ let arregloexpresion_logica4 = []; arregloexpresion_logica4.push($1); arregloexpresion_logica4.push($2); $$ = new ast("expresion_logica", arregloexpresion_logica4);}
